...
st.write("Answer the questions below and find out which iconic character you're most like! 1 stands for GREAT, 2 stands for AVERAGE and 3 stands for POOR")

answers = []
for idx, question in enumerate(questions):
   answer = st.selectbox(f"**{question}**", answer_choices, key=idx)
answers.append(answer_choices.index(answer) + 1)
